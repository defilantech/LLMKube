...
echo "🚀 LLMKube Multi-GPU EKS Cluster Setup"
echo "======================================"
...
echo "✅ Selected: ${GPU_COUNT}x $GPU_NAME GPUs on $GPU_INSTANCE"
...
# Apply
echo ""
echo "🏗️  Creating multi-GPU cluster (this takes ~15-20 minutes)..."
...
# Test GPU allocation
echo "🧪 Testing ${GPU_COUNT}-GPU allocation..."
...
if kubectl get pod multi-gpu-test -o jsonpath='{.status.phase}' | grep -q "Running\\|Succeeded"; then
    ...
    echo ""
    echo "✅ SUCCESS: $GPU_COUNT GPUs detected!"
else
    echo ""
