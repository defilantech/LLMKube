...
echo "🚀 LLMKube Multi-GPU GKE Cluster Setup"
echo "======================================"
...
echo "✅ Selected: 2x $GPU_NAME GPUs on $MACHINE_TYPE"
...
# Apply
echo ""
echo "🏗️  Creating multi-GPU cluster (this takes ~10-15 minutes)..."
...
# Verify
echo ""
echo "✅ Multi-GPU cluster created successfully!"
echo ""
echo "📊 Cluster nodes:"
kubectl get nodes -o wide
echo ""
echo "🎮 GPU allocation (may show 0 if auto-scaled down):"
kubectl get nodes -o custom-columns=NAME:.metadata.name,GPU:.status.allocatable."nvidia\.com/gpu"
echo ""

# Test GPU allocation
echo "🧪 Testing 2-GPU allocation..."
