...
echo "🚀 LLMKube Multi-GPU Azure AKS Cluster Setup"
echo "============================================="
...
echo ""
echo "🔍 Checking GPU quota in West US 2..."
echo ""
...
if [[ ! "$QUOTA_OK" =~ ^[Yy]$ ]]; then
    echo ""
    echo "⚠️  Please request GPU quota before proceeding:"
...
echo "✅ Selected: 2x $GPU_NAME GPUs ($GPU_VM_SIZE)"
...
echo ""
echo "📝 Creating terraform.tfvars for multi-GPU configuration..."
...
echo ""
echo "💡 Remember to run 'terraform destroy' when done testing!"
echo ""
...
# Deploy
echo ""
echo "🚀 Deploying AKS cluster with multi-GPU support..."
...
echo ""
echo "=================================================="
echo "✅ Multi-GPU AKS Cluster Deployed Successfully!"
echo "=================================================="
echo ""
...
echo ""
echo "📖 Full documentation: ../../docs/MULTI-GPU-DEPLOYMENT.md"
echo ""
