...
type InferenceServiceSpec struct {
	...
	// for runtimes that serve via the image entrypoint (llamacpp, generic),
	// Command overrides the entrypoint only and the runtime's generated args
	// (model path, context size, host/port, ...) still apply.
	// +optional
